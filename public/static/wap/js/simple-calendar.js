...
var SimpleCalendar = function () {
  ...
  _createClass(SimpleCalendar, [{
    ...
    value: function create() {
      ...
      //actions
      header.innerHTML = header.innerHTML + '<div class="sc-actions hide">' + '      <div class="sc-yleft ">' + '        &lsaquo;</div>' + '      <select class="sc-select-year" name="">' + '      </select>' + '      <div class="sc-yright">&rsaquo;</div>' + '  </div>';
      ...
      for (var i = 0; i < 35; i++) {
        ...
        if (this._options.showLunarCalendar) {
          ...
          daysElement[i].classList.add('item-nolunar');
           daysElement[i].classList.add('aabbcc');
        }
